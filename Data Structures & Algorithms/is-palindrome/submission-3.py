class Solution:
    def isPalindrome(self, s: str) -> bool:
        ...
        while l < r: # when left pointer intersects with right then we know that entire string has been processed
            while l < r and not self.isalnum(s[l]): # move left pointer toward center until it reaches a alphanumeric
                l += 1
            while r > l and not self.isalnum(s[r]): # move right pointer toward center until it reaches a alphanumeric
                r += 1
